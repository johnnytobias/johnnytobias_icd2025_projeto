...
1. left_join (vendas->produtos) mantem todas as vendas, mesmo sem correspondencia na tabela de produtos

2. right_join(vendas->produtos) ou left_join(produtos   vendas) mantem todos osn produtos,mesmo sem venda

3. full_join mantem todos so registro de ambas as tabelaspara uma analise completa

4. inner_join mante apenas regisstro com correspondencia em todas as tabelas 
