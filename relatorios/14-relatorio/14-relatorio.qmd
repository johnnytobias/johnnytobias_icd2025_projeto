...
1. Qual é a população? 8.000
2. Qual é a amostra? 120 amotra
3. O que representa $\mu$? μ
  = Qualidade média verdadeira de todas as 8.000 garrafas - parâmetro fixo mas desconhecido
4. O que representa $\bar{x}$?x¯
: Qualidade média das 120 garrafas avaliadas - estimativa de μ
.
5. Por que não avaliar todas as garrafas? Limitações: Custo elevado, tempo excessivo, e possível natureza destrutiva dos testes.
...
1. Qual é a população?1.200 lojas
2. Qual é a amostra?80 lojas
3. O que representa $\mu$?μ
 = Ticket médio verdadeiro de todas as 1.200 lojas.
4. O que representa $\bar{x}$?x¯
  = Ticket médio calculado das 80 lojas analisadas.
5. Vantagens da abordagem amostral?Economia significativa de tempo e recursos, conclusões mais rápidas para decisões, precisão adequada para fins práticos, análises mais detalhadas possíveis.
...
Parâmetro   ##(σ - desvio padrão populacional)##
